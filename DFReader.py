...
def dfRead(HPPword, HPPkey, HPPwordList): 
    ...
    csvfile_1989_wordList = open('TF-IDF OUTPUT (1989) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1990_wordList = open('TF-IDF OUTPUT (1990) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1991_wordList = open('TF-IDF OUTPUT (1991) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1992_wordList = open('TF-IDF OUTPUT (1992) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1993_wordList = open('TF-IDF OUTPUT (1993) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1994_wordList = open('TF-IDF OUTPUT (1994) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1995_wordList = open('TF-IDF OUTPUT (1995) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1996_wordList = open('TF-IDF OUTPUT (1996) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1997_wordList = open('TF-IDF OUTPUT (1997) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1998_wordList = open('TF-IDF OUTPUT (1998) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_1999_wordList = open('TF-IDF OUTPUT (1999) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2000_wordList = open('TF-IDF OUTPUT (2000) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2001_wordList = open('TF-IDF OUTPUT (2001) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2002_wordList = open('TF-IDF OUTPUT (2002) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2003_wordList = open('TF-IDF OUTPUT (2003) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2004_wordList = open('TF-IDF OUTPUT (2004) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2005_wordList = open('TF-IDF OUTPUT (2005) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2006_wordList = open('TF-IDF OUTPUT (2006) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2007_wordList = open('TF-IDF OUTPUT (2007) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2008_wordList = open('TF-IDF OUTPUT (2008) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2009_wordList = open('TF-IDF OUTPUT (2009) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2010_wordList = open('TF-IDF OUTPUT (2010) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2011_wordList = open('TF-IDF OUTPUT (2011) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2012_wordList = open('TF-IDF OUTPUT (2012) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2013_wordList = open('TF-IDF OUTPUT (2013) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2014_wordList = open('TF-IDF OUTPUT (2014) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2015_wordList = open('TF-IDF OUTPUT (2015) RAW WORDS FOR DF CALC.csv', 'r+')
    csvfile_2016_wordList = open('TF-IDF OUTPUT (2016) RAW WORDS FOR DF CALC.csv', 'r+')
    ...
    print("===================================================== COMPARING NEW WORD ===================================: " + HPPword + " HPPkey: " + str(HPPkey))
    '''
