...
class AlchemyAPI:
    ...
    def entities(self, flavor, data, options={}):
        ...
        quotations -> extract_jree quotations by entities. 0: disabled (default), 1: enabled.
    ...
    def relations(self, flavor, data, options={}):
        ...
        keywords -> extract_jree keywords from the subject and object. 0: disabled (default), 1: enabled. Requires one additional API transaction if enabled.
        entities -> extract_jree entities from the subject and object. 0: disabled (default), 1: enabled. Requires one additional API transaction if enabled.
        requireEntities -> only extract_jree relations that have entities. 0: disabled (default), 1: enabled.
        ...
        showSourceText -> 0: disabled (default), 1: enabled.
        maxRetrieve -> the maximum number of relations to extract_jree (default: 50, max: 100)
    ...
    def combined(self, flavor, data, options={}):
        ...
        maxRetrieve ->
            maximum number of named entities to extract_jree
            default : 50
