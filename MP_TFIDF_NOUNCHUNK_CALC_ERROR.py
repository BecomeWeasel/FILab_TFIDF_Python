...
def DFCHECK(setStart, setEnd):
    ...
    for wordAndDFCounts in reader:
        ...
        print("compared with old : " + word_DFCOUNTs[5] + " , " + str(firstDF))

        if firstDF != int(word_DFCOUNTs[5]):
        ...
        elif firstDF == int(word_DFCOUNTs[5]):
        ...
        print("compared with old : " + word_DFCOUNTs[25] + " , " + str(secondDF))

        if secondDF != int(word_DFCOUNTs[25]) and isError is False:
            # check old DFCOUNT. If it is invalid, DFCALC procedure will be called.
        ...
        elif secondDF != int(word_DFCOUNTs[25]) and isError is True:
            print("Error at " + word_DFCOUNTs[0] + " in 2000 but correction already done.")

        elif secondDF == int(word_DFCOUNTs[25]):
        ...
        print("compared with old : " + word_DFCOUNTs[36] + " , " + str(thirdDF))

        if thirdDF != int(word_DFCOUNTs[36]) and isError is False:
            # check old DFCOUNT. If it is invalid, DFCALC procedure will be called.
            # And if isError is True, it means that DFCALC was already called, so don't need to do that again.
        ...
        elif thirdDF != int(word_DFCOUNTs[36]) and isError is True:
            print("Error at " + word_DFCOUNTs[0] + " in 2010 but correction already done.")

        elif thirdDF == int(word_DFCOUNTs[36]):
...
totalErrorCount=DFCHECK(18022, 18023)
